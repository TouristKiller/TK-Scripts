-- @description TK_Trackname_Toggle_Child_Normal
-- @author TouristKiller
-- @version 1.0
-- @changelog:
--   v1.0: Initial release
-- @about Combo toggle for Child + Normal track names. If both are on they turn off, otherwise both turn on
...
local keys = { "show_child_tracks", "show_normal_tracks" }
