-- @description TK_Trackname_Toggle_Parent_Child
-- @author TouristKiller
-- @version 1.0
-- @changelog:
--   v1.0: Initial release
-- @about Combo toggle for Parent + Child track names. If both are on they turn off, otherwise both turn on
...
local keys = { "show_parent_tracks", "show_child_tracks" }
