-- @description TK_Trackname_Toggle_Parent
-- @author TouristKiller
-- @version 1.0
-- @changelog:
--   v1.0: Initial release
-- @about Toggle visibility of Parent (folder) track names on/off, independent of Child and Normal tracks
...
SetButtonState(settings.show_parent_tracks and 1 or 0)
r.UpdateArrange()
