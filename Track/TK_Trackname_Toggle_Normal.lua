-- @description TK_Trackname_Toggle_Normal
-- @author TouristKiller
-- @version 1.0
-- @changelog:
--   v1.0: Initial release
-- @about Toggle visibility of Normal track names on/off, independent of Parent and Child tracks
...
SetButtonState(settings.show_normal_tracks and 1 or 0)
r.UpdateArrange()
