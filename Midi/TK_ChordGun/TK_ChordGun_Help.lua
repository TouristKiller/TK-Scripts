...
local helpContent = {
	-- Tab 1: Getting Started
	{
		...
		"• BASS: Add root note 1 or 2 octaves lower (Off/-1/-2)",
	...
	-- Tab 2: Scale System
	{
		...
		"  Jazz, World Music, Blues & Soul, Rock & Metal",
		"",
		...
		"",
		"DIATONIC (11 scales) - Western classical and pop",
		"Major, Minor variants (Natural/Harmonic/Melodic),",
		...
		"Mode 2: Octatonic/Diminished (3 transpositions)",
		"Mode 3-7: Various symmetrical patterns",
	...
	{
		"SCALE REFERENCE",
		"Complete Encyclopedia of All 87 Scales",
		"",
		"=== DIATONIC SCALES (11) ===",
		...
		"   Example: A Melodic Minor = A-B-C-D-E-F#-G#",
		"",
		"5. DORIAN",
		...
		"",
		"5. JAPANESE (Hirajoshi)",
		"   Intervals: 2-1-4-1-4",
		"   Character: Traditional Japanese, spacious",
		"   Use: Koto music, ambient, meditation",
		"   Example: C Hirajoshi = C-D-Eb-G-Ab",
		"",
		"6. HIRAJOSHI VARIANT",
		"   Intervals: 1-4-1-4-2",
		"   Character: Dark Japanese, contemplative",
		"   Use: Traditional, film scores",
		"   Example: C Variant = C-Db-F-Gb-Bb",
		"",
		"=== MESSIAEN MODES (32) ===",
		...
		"",
		"5. ALTERED SCALE",
		"   Intervals: 1-2-1-2-2-2-2 (7 notes)",
		"   Character: Super Locrian, all alterations",
		"   Use: Dominant 7 with b9, #9, #11, b13",
		"   7th mode of melodic minor",
		"",
		"6. LYDIAN DOMINANT",
		"   Intervals: 2-2-2-1-2-1-2 (7 notes)",
		"   Character: Acoustic/Overtone scale",
		"   Use: #11 with b7, Bartók, Debussy",
		...
		"",
		"8. MELODIC MINOR",
		"   Intervals: 2-1-2-2-2-2-1 (7 notes)",
		"   Character: Jazz minor",
		"   Use: Foundation of modern jazz harmony",
		"   Natural minor with raised 6 and 7",
		"",
		"9. WHOLE HALF DIMINISHED",
		"   Intervals: 2-1-2-1-2-1-2-1 (8 notes)",
		"   Character: Symmetrical diminished",
		"   Use: Dim7 and dom7b9 chords",
		"",
		"10. HALF WHOLE DIMINISHED",
		"   Intervals: 1-2-1-2-1-2-1-2 (8 notes)",
		"   Character: Symmetrical diminished",
		"   Use: Diminished chords and lines",
		"",
		"=== WORLD MUSIC SCALES (12) ===",
		...
		"2. PHRYGIAN DOMINANT",
		"   Intervals: 1-3-1-2-1-2-2",
		"   Character: Spanish/Flamenco essential",
		"   Use: Flamenco, metal, film scores",
		"   Phrygian with major 3rd (Hijaz/Freygish)",
		"",
		"3. DOUBLE HARMONIC",
		"   Intervals: 1-3-1-2-1-3-1",
		...
		"1. HARMONIC MINOR",
		"   Intervals: 2-1-2-2-1-3-1",
		"   Character: Classical/metal favorite",
		"   Use: Neoclassical metal, Yngwie Malmsteen",
		"   Natural minor + major 7th, dramatic",
		"",
		"2. PHRYGIAN DOMINANT",
		"   Intervals: 1-3-1-2-1-2-2",
		"   Character: Metal staple",
		"   Use: Metallica, Slayer, progressive metal",
		...
		"6. LYDIAN #2",
		"   Intervals: 1-2-2-2-1-2-2",
		"   Character: Bright and angular",
		"   Use: Progressive metal, math rock",
		"   Lydian with raised 2nd",
		"",
		"7. SUPER LOCRIAN",
		"   Intervals: 1-2-1-2-2-2-2",
		"   Character: Altered/diminished",
		"   Use: Extreme metal, technical death metal",
		"   7th mode of melodic minor",
		"",
		"8. AEOLIAN b5",
		"   Intervals: 2-1-2-1-2-2-2",
		"   Character: Half-diminished sound",
		"   Use: Doom metal, atmospheric metal",
	...
	-- Tab 4: Chord Controls
	{
		...
		"",
		"=== BASS BUTTON ===",
		"Cycle button (Bass Off / Bass -1 / Bass -2):",
		"• Adds the root note of the chord in lower octaves",
		"• Bass -1: Adds root note 1 octave below",
		"• Bass -2: Adds root note 2 octaves below",
		"• Great for fuller sounding chords or piano styles",
		"",
		"=== CHORD RECOGNITION ===",
	...
	-- Tab 5: Advanced
	{
		...
		"• Diatonic: Uses first 7 keys (a-g, q-u, z-v)",
		"• Messiaen 9-note: Uses all 9 keys per row",
		...
		"• Fifths/Chromatic button: Toggle view mode",
	...
	-- Tab 6: About
	{
		...
		"• Expanded scale library (8 → 87 scales)",
