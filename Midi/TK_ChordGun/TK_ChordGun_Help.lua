...
local helpLines = {
	...
	"• Includes 8 Messiaen Modes of Limited Transposition (symmetrical)",
	"• Window width adjusts automatically for 5-9 note scales",
	...
	"• Circle of Fifths button: Open interactive circle visualization",
	"",
	"=== CIRCLE OF FIFTHS ===",
	"• Click any note to change tonic instantly",
	"• #/b button: Toggle between sharp and flat notation",
	"• Diatonic scales: Harmonic distance color coding",
	"  - Gold: Tonic",
	"  - Green: Dominant (+1 fifth)",
	"  - Magenta: Subdominant (-1 fifth)",
	"  - Cyan: Supertonic (+2 fifths)",
	"  - Orange: Submediant (+3 fifths)",
	"  - Terracotta: Mediant (+4 fifths)",
	"  - Brown: Leading tone (tritone)",
	"• Messiaen modes: Simplified coloring",
	"  - Gold: Tonic/root note",
	"  - Light blue: All other notes in scale",
	"  - Gray: Notes outside scale",
	"• Auto-syncs with main window without closing",
	"• Shows scale symmetry patterns visually",
	"",
	"=== KEYBOARD SHORTCUTS (Scale Degrees 1-9) ===",
	"Preview (lowercase):",
	"• a s d f g h j k l: Preview scale notes (current octave)",
	"• z x c v b n m , .: Preview scale notes (lower octave)",
	"• q w e r t y u i o: Preview scale notes (higher octave)",
	"• 1 2 3 4 5 6 7 8 9: Preview chords",
	"• Note: Shortcuts adapt to scale size (1-7 for diatonic, 1-9 for Messiaen)",
	"",
	"Insert (uppercase/shift):",
	"• A S D F G H J K L: Insert scale notes (current octave)",
	"• Z X C V B N M < >: Insert scale notes (lower octave)",
	"• Q W E R T Y U I O: Insert scale notes (higher octave)",
	"• ! @ # $ % ^ & * (: Insert chords",
	"",
	"Other Keys:",
	...
	"• Messiaen modes show simple numbers (1-9) instead of Roman numerals",
	"• Circle of Fifths adapts display for diatonic vs Messiaen scales",
	"• Keyboard shortcuts work up to 9 notes for Messiaen Mode 7.1",
