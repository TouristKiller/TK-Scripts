...
local helpContent = {
	-- Tab 1: Getting Started
	{
		...
		"• Safety fix: No crash when switching scales during playback",
		"",
		"=== NEW IN v2.3.3 ===",
		...
		"• Harmonic Compass: Redesigned with colored corner squares",
		...
		"",
		"=== NEW IN v2.3.1 ===",
		"• Harmonic Compass: Smart suggestions highlight logical next chords (Green outline)",
		"• Randomize Update: Added 'Use Selected Chord Types' option (Right-click Dice)",
		"• Extended Chord Vocabulary: Added 9th, 11th, 13th, 6/9, etc.",
		"• Filter Dropdown: Control chord visibility (Basic, Standard, Jazz)",
		"• 'All' Modes: Show chords outside the scale (Std All, Jazz All)",
		"• Replaced 'In Scale' toggle with the new Filter Dropdown",
		"",
		"=== NEW IN v2.3.0 ===",
		"• Right-Click Chord Buttons: Opens new Context Menu",
		"• Generate ii-V-I: Instantly add jazz cadences leading to target chord",
		"• Tritone Substitution: Add chromatic ii-bII-I progressions",
		"• Insert Options: Choose between 'Insert to MIDI' or 'Add to Progression'",
		"• JSFX Fixes: Fixed Scale Filter syntax and Light Theme colors",
		"• Stability: Fixed crash when inserting generated chords without item",
		"",
		"=== NEW IN v2.2.7 ===",
	...
	-- Tab 4: Chord Controls
	{
		...
		"",
		"=== FILTER DROPDOWN (New in v2.3.1) ===",
		"Controls which chords are visible in the list:",
		"• Basic: Shows only Triads (Major, Minor, Dim, Aug, Sus)",
		"• Standard: Shows Triads + 7th chords (Default)",
		"• Jazz: Shows Extended chords (9th, 11th, 13th, 6/9, etc.)",
		"• Std (All): Standard chords, including those outside the scale (greyed out)",
		"• Jazz (All): Extended chords, including those outside the scale",
		"",
		"=== CONTEXT MENU (Right-Click) ===",
		"New in v2.3.0 - Right-click any chord button to access:",
