...
local settings_active_top_tab = 1
...
function ShowSettings(main_window_width , main_window_height)
 ...
 do
  ...
  for i, t in ipairs(_tabs_def) do
   ...
   local is_active = (settings_active_top_tab == t.idx)
 ...
 local transport_tab_active = (settings_active_top_tab == 1)
 local buttons_tab_active   = (settings_active_top_tab == 2)

 if settings_active_top_tab == 1 then
 local window_width = r.ImGui_GetWindowWidth(ctx)
 ...
 if settings_active_top_tab == 2 then
 local window_width = r.ImGui_GetWindowWidth(ctx)
 local split_pos = math.floor(window_width * 0.2) 
...
if r.ImGui_SmallButton(ctx, "🔘") then
 ...
 if settings_active_top_tab == 3 then
